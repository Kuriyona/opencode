...
export const dict = {
  ...
  "settings.search.scope.label": "Search scope",
  "settings.search.scope.all": "All settings",
  "settings.search.scope.app": "App settings",
  "settings.search.count.one": "{{count}} result",
  "settings.search.count.other": "{{count}} results",
  "settings.search.empty": "No settings found",
  "settings.search.hint": "Try a setting, server, or project name.",
  "settings.search.refine": "Narrow your search to see more specific results.",
  "settings.search.unavailable": "Server unavailable",
  "settings.search.coverage": "{{server}} is unavailable. Only connection settings are searchable.",
  "settings.search.catalogHint":
    "Searches settings and known projects. Find individual models and shortcuts on their pages.",
  "settings.search.back": "Back to search",
  "settings.search.exit": "Clear search",
